...
public class Main {
    public static void main(String[] args) {
        ...
        String[] dataPengiriman = new String[maximalData];
                        ...
                        if (Login) {
                            ...
                            switch (PilihanAdmin) {
                                case 1:
                                    if (dataBaru < maximalData) {
                                        ...
                                        if (AlamatPenerima.equals("Malang") && AlamatPengirim.equals("Jakarta")) {
                                            ...
                                            else if (AlamatPenerima.equals("Malang")
                                                    && AlamatPengirim.equals("Surabaya"))

                                                Jarak = 40;

                                        } else if ((AlamatPenerima.equals("Jakarta")
                                                && AlamatPengirim.equals("Malang"))) {
                                        ...
                                        } else if (AlamatPenerima.equals("Bandung")
                                                && AlamatPengirim.equals("Malang")) {
                                            ...
                                            if ((AlamatPenerima.equals("Bandung") && AlamatPengirim.equals("Surabaya")))
                                                ...
                                                Jarak = 750;
                                                    ...
                                                    && AlamatPengirim.equals("Jakarta"))

                                                Jarak = 150;

                                        } else if (AlamatPenerima.equals("Surabaya")
                                                && AlamatPengirim.equals("Malang")) {
                                ...
                                case 3:
                                    ...
                                    int cariNomorResi = inputPilihan.nextInt();
                                    boolean ditemukan = false;

                                    for (int i = 0; i < maximalData; i++) {
                                        String[] data = dataPengiriman[i].split(",");
                                        int nomorResi = Integer.parseInt(data[0]);
                                        if (nomorResi == cariNomorResi) {
                                            System.out.println(
                                                    "Data Pengiriman dengan Nomor Resi " + cariNomorResi
                                                            + " ditemukan:");
                                            System.out.println("\n============= Resi Pengiriman =============");
                                            System.out.println("Nama Pengirim             : " + data[1]);
                                            System.out.println("Nomor Telepon Pengirim    : " + data[2]);
                                            System.out.println("Alamat Pengirim           : " + data[3]);
                                            System.out.println("Tanggal Pengiriman        : " + data[4]);
                                            System.out.println("Nama Penerima             : " + data[5]);
                                            System.out.println("Nomor Telepon Penerima    : " + data[6]);
                                            System.out.println("Alamat Penerima           : " + data[7]);
                                            System.out.println("Kode Pos                  : " + data[8]);
                                            System.out.println("Jenis Layanan             : " + data[9]);
                                            System.out.println("Jenis Barang              : " + data[10]);
                                            System.out.println("Nomor Resi                : " + data[11]);
                                            System.out.println("Berat Barang (in kg)      : " + data[12]);
                                            System.out.println("________________________________________________");
                                            System.out.println("Total Biaya               : Rp." + TotalBiaya);
                                        }
                                    }
                    ...
                    while (true) {
                        if (Login) {
                            ...
                            for (int i = 0; i < maximalData; i++) {
                                ...
                                if (nomorResi == cariNomorResi) {
                                    System.out.println(
                                            "Data Pengiriman dengan Nomor Resi " + cariNomorResi + " ditemukan:");
                                    System.out.println("\n============= Resi Pengiriman =============");
                                    System.out.println("Nama Pengirim             : " + data[1]);
                                    System.out.println("Nomor Telepon Pengirim    : " + data[2]);
                                    System.out.println("Alamat Pengirim           : " + data[3]);
